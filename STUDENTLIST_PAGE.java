...
try {// Load the MySQL driver
    ...
    ResultSet resultSet = statement.executeQuery("SELECT FIRSTNAME, LASTNAME, STUDENTID FROM STUDENT_BORROWER");
    while (resultSet.next()) {
    	
    	JButton label10 = new JButton((resultSet.getString(3)));
    	
    	panel.add(label10);
    	f.add(label10);
        label10.setBounds(150, n,800, 40);
