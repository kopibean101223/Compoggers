...
try {// Load the MySQL driver
    ...
    ResultSet resultSet = statement.executeQuery("SELECT LASTNAME,FIRSTNAME,INITIAL FROM STUDENT_BORROWER WHERE STUDENTID = "+"'"+ STUDENTLIST_PAGE.pgcnchkr+"';");
    ...
    resultSet = statement.executeQuery("SELECT COURSE FROM STUDENT_BORROWER WHERE STUDENTID = "+"'"+ STUDENTLIST_PAGE.pgcnchkr+"';");
    while (resultSet.next()) {
    ...
    resultSet = statement.executeQuery("SELECT YEARLVL FROM STUDENT_BORROWER WHERE STUDENTID = "+"'"+ STUDENTLIST_PAGE.pgcnchkr+"';");
    while (resultSet.next()) {
    ...
    resultSet = statement.executeQuery("SELECT SECTION FROM STUDENT_BORROWER WHERE STUDENTID = "+"'"+ STUDENTLIST_PAGE.pgcnchkr+"';");
    while (resultSet.next()) {
    ...
    resultSet = statement.executeQuery("SELECT PENALTY FROM STUDENT_BORROWER WHERE STUDENTID = "+"'"+ STUDENTLIST_PAGE.pgcnchkr+"';");
    while (resultSet.next()) {
    ...
    int h=640;
    resultSet = statement.executeQuery("SELECT TITLE FROM BOOK_DETAILS WHERE BORROWER_ID = "+"'"+ STUDENTLIST_PAGE.pgcnchkr+"';");
    while (resultSet.next()) {
    	JLabel RSlbl = new JLabel("BORROWED BOOKS : "+resultSet.getString(1));
    	f.add(RSlbl);
